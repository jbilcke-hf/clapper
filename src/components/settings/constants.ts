...
export const ClapWorkflowProviderShortNames = {
  ...
  [ClapWorkflowProvider.COMFY_COMFYICU]: 'Comfy.icu',
  [ClapWorkflowProvider.COMFY_HUGGINGFACE]: 'Hugging Face Comfy',
  [ClapWorkflowProvider.COMFY_REPLICATE]: 'Replicate Comfy',
