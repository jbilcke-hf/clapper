...
export const FruityWindow: React.FC<{
  ...
  }, [addWindow, canBeClosed, canBeReduced, defaultHeight, defaultWidth, defaultX, defaultY, id, title, win])
  ...
  const handleResize = useCallback(
    ...
    [dragOffset, id, isResizing, minHeight, minWidth, resizeDirection, updateWindowPosition, updateWindowSize, win]
  )
    ...
    () =>
      win
        ? cn(
            ...
            win.isFocused ? 'shadow-xl' : '',
            isFullscreen ? 'fixed inset-0' : ''
          )
        : 'display-none',
    [win, win?.isFocused, isFullscreen]
  )
